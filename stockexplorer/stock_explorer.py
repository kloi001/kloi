...
sector_list_json.to_json(r'C:\Users\kentl\stockexp\sectorinterest.json')
sector_list_json.to_csv(r'C:\Users\kentl\stockexp\sectorinterest.csv')
...
stock_exp_indiv_info = ("company_name_ticker", "profile", "market_cap", "div", "shares_outstanding", "shares_float", "prev_close", 
                  ...
                  "debt_equity", "op_margin", "profit_margin", "sales_qonq", "roa", "roe", "roi", "eps_ttm", "eps_fwd", "eps_q",
    ...
    try:
        ...
        with open('stockdata.json') as json_file:
            ...
            stock_indiv = pd.DataFrame([[company_name_ticker, profile, market_cap, dividend, shares_outstanding, shares_float, 
                                         ...
                                         current_ratio, debt_equity, op_margin, profit_margin, sales_qoq, roa, roe, roi, eps_ttm, 
                                         eps_fwd, eps_q, book_value_share, cash_share, pe, pe_fwd, peg, ps, pb, pc, pfcf]], 
                                        columns=stock_exp_indiv_info)
            
            stock_exp_indiv = stock_exp_indiv.append(stock_indiv, ignore_index=True)
            
            stock_exp_indiv.to_csv(r'C:\Users\kentl\stockexp\stockexplorermain'+ ticker_name +'.csv')
...
stock_exp.to_json(r'C:\Users\kentl\stockexp\stockexplorermain.json')
stock_exp.to_csv(r'C:\Users\kentl\stockexp\stockexplorermain.csv')
